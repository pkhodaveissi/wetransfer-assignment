...
import RoomsErrorBoundary from './components/RoomsErrorBoundary'
function Rooms() {
  ...
  return (
    <RoomsErrorBoundary>
      <div className='p-[30px]'>
        ...
        {
          {
            success: data?.rooms ? <RoomList items={data.rooms} /> : null, // the ternary is there so the RoomList function never runs if we don't have data
